import {
  ...
  isPropValid,
  memoize
} from "./chunk-2E6KOAY2.js";
import {
  require_jsx_runtime
} from "./chunk-ID2KPZG4.js";
import {
  require_react
} from "./chunk-KWVJZRSD.js";
import {
  __commonJS,
  __toESM
...
function useCurrentColorScheme(options) {
  ...
  const modeStorage = React20.useMemo(() => storageManager?.({
    key: modeStorageKey,
    storageWindow
  }), [storageManager, modeStorageKey, storageWindow]);
  const lightStorage = React20.useMemo(() => storageManager?.({
    key: `${colorSchemeStorageKey}-light`,
    storageWindow
  }), [storageManager, colorSchemeStorageKey, storageWindow]);
  const darkStorage = React20.useMemo(() => storageManager?.({
...
//# sourceMappingURL=chunk-5MNKVQMW.js.map
